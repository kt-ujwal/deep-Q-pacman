...
testing =True
# Model path
test_model_path = '/home/kt_ujwal/Desktop/pacman/tmp/model/qlearning.ckpt-508000'
#path_to_ckpt_meta='/home/kt_ujwal/Desktop/qlearning.ckpt-12000.meta'
# Atari game to learn
game = 'MsPacman-v0'
# Learning threads
n_threads = 8
...
T = 0
# Cosecutive screen frames when performing training
action_repeat = 4
...
summary_dir = '/home/kt_ujwal/Desktop/pacman/tmp/tflearn_logs/'
...
#   ATARI Environment Wrapper helper class
class AtariEnvironment(object):
    ...
    def __init__(self, gym_env, action_repeat):
        ...
        self.gym_actions = range(gym_env.action_space.n) # Agent available actions:LEFT,RIGHT,UP n DOWN.
...
'''helper function'''
# Setting up some episode summary ops to visualize on tensorboard.
def build_summaries():
...
def train(session, graph_ops, num_actions, saver):    
    ...
    # Show the agents training and write summary statistics #HELPER CLASS
    last_summary_time = 0
    while True:
        if show_training:
            for env in envs:
